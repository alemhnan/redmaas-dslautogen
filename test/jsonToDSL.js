...
var grammar = {
    ...
    {"name": "json$subexpression$1", "symbols": ["value"]},
    {"name": "json$ebnf$2", "symbols": []},
    {"name": "json$ebnf$2", "symbols": [/[\s]/, "json$ebnf$2"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    {"name": "json", "symbols": ["json$ebnf$1", "json$subexpression$1", "json$ebnf$2"], "postprocess": function(d) { console.log(d);return d[1][0]; }},
